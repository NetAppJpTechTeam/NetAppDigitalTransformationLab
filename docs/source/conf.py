# -*- coding: utf-8 -*-
#
# Data Technology Lab documentation build configuration file, created by
...
man_pages = [
    (master_doc, 'NetAppDigitalTransformationLabdoc', u'NetApp Digital Transformation Lab Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'NetAppDigitalTransformationLab', u'NetApp Digital Transformation Lab Documentation',
     author, 'NetApp Digital Transformation Lab', 'One line description of project.',
     'Miscellaneous'),
]
